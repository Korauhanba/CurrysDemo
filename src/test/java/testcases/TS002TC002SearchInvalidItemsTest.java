...
//TS002_TC002_Search invalid items
public class TS002TC002SearchInvalidItemsTest extends BaseTest {
	
	//Verify the search of non existing or invalid items
	@Test(dataProviderClass = DataUtil.class, dataProvider = "dp1")
	public void searchInvalidProduct(String browser, String searchData, String expPageTitle) {
		...
		// Search the product based on invalid product data entered
